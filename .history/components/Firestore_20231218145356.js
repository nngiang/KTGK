  ...
  const handleAddData = async () => {
    try {
      ...
      await moviesRef.add({
          ...
          director: 'Đạo diễn Martin Scorsese',
          year: 2023,
          images:'https://i.mpcdn.top/c/wo52GjZ/vang-trang-mau.jpg?1702664730',
          details:Vầng trăng máu (tựa tiếng Anh: Killers of the Flower Moon) là một bộ phim điện ảnh Mỹ thuộc thể loại lịch sử – tội phạm – giật gân – chính kịch[5] ra mắt vào năm 2023 do Martin Scorsese làm đạo diễn, viết kịch bản và đồng sản xuất, được dựa trên cuốn sách phi hư cấu cùng tên ra mắt vào năm 2017 của David Grann.[6][7] Lấy chủ đề về vụ thảm sát hàng loạt ở khu tự trị Osage của bang Oklahoma vào những năm 1920, phim theo chân Ernest Buckhart, một người da trắng đang vướng vào mối tình với Mollie – một cô gái thuộc bộ tộc Osage, và từ đây hành trình cảm xúc của anh trở nên phức tạp khi bị mắc kẹt giữa thời buổi loạn lạc này. Với sự tham gia diễn xuất của Leonardo DiCaprio, Robert De Niro và Lily Gladstone, cùng dàn diễn viên phụ gồm Jesse Plemons, Tantoo Cardinal, John Lithgow và Brendan Fraser, tác phẩm đã đánh dấu Scorsese có lần thứ sáu hợp tác với DiCaprio và lần thứ mười hợp tác với De Niro.[8] Cá nhân DiCaprio cũng tham gia làm giám đốc sản xuất cho bộ phim.',
