  ...
  const handleAddData = async () => {
    try {
      ...
      await moviesRef.add({
          ...
          Trong quá trình điều tra các nhân vật chính phải đối mặt với những thử thách nguy hiểm đồng thời phải đối phó với những mưu mô âm mưu của tổ chức tội phạm. Phim mang đến cho khán giả những pha hành động gay cấn đấu võ đỉnh cao và những tình huống căng thẳng.Ngoài ra,Lật Mặt cũng có sự tham gia của các diễn viên nổi tiếng như Lý Hải, Hồng Ánh, Huỳnh Đông, Kim Hương, Thái Hoà... Được đánh giá là một trong những bộ phim hành động nổi bật của điện ảnh Việt Nam vào thời điểm ra mắt, Lật Mặt đã thu hút được sự chú ý và có được sự ủng hộ từ phần lớn khán giả.",
