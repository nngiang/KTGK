        ...
        <View>
          <View style={styles.bankButtonsContainer}>
            <TouchableOpacity
              ...
              onPress={() => handleBankPayment('Bank A')}>
              {/* Replace the placeholder text and add Bank A icon */}
              <Text style={styles.bankButtonText}>Bank A</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.bankButton}
              onPress={() => handleBankPayment('Bank B')}>
              {/* Replace the placeholder text and add Bank B icon */}
              <Text style={styles.bankButtonText}>Bank B</Text>
            </TouchableOpacity>
