...
const MovieDetailScreen = ({ route }) => {
  ...
  const handleBooking = () => {
    navigation.navigate('BookingScreen', { movieId, movieTitle });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <TouchableOpacity onPress={() => navigation.navigate('BookingScreen', { movieId: movieId, movieTitle: movieDetails.title })}>
  <Text>Đặt vé</Text>
</TouchableOpacity>
      </View>
    </View>
