...
const PaymentScreen = () => {
  ...
  const { selectedSeats, movieId } = route.params; // Lấy selectedSeats và movieId từ route.params
  ...
  const handlePayment = () => {
    navigation.navigate('PaymentScreen', { movieId });
  };
    ...
    <View style={styles.container}>
      {paymentCompleted ? (
        ...
        <TouchableOpacity
          ...
          onPress={handlePayment}> {/* Gọi handlePayment trực tiếp trong onPress */}
