...
const PaymentScreen = () => {
  ...
  const handlePayment = async () => {
    try {
      // Giả sử là đây là một hàm thực tế để gửi thông tin thanh toán tới server hoặc dịch vụ thanh toán
      // Chú ý rằng bạn cần thay thế hàm này bằng cách gửi dữ liệu thanh toán đến server hoặc dịch vụ thanh toán thực tế
      const paymentResult = await sendPaymentInformationToServer({
        movieId: movieId,
