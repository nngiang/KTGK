...
import { useRoute } from '@react-navigation/native'; // Import useRoute từ thư viện react-navigation/native

const PaymentScreen = ({ navigation }) => {
  const route = useRoute(); // Sử dụng useRoute để lấy thông tin route
  const { selectedSeats, movieId, movieTitle } = route.params;
      ...
      {paymentCompleted ? (
        <View>
          ...
          <View style={styles.paymentDetails}>
            ...
            <Text style={styles.detailText}>{generateQRCodeData()}</Text>
