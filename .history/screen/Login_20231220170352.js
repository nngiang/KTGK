    ...
    try {
      ...
      if (currentUser) {
        ...
        if (doc.exists) {
          ...
          const isAdmin = userData.isAdmin || false; // Kiểm tra trường isAdmin trong document của người dùng
          ...
          // Nếu không tìm thấy thông tin người dùng, chuyển hướng đến trang người dùng thông thường
          navigation.navigate('HomeScreen');
        }
      }
    } catch (error) {
