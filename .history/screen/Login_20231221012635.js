...
const Login = ( {navigation} ) => {
  ...
  const [user, setUser] = useState({
    // Điều quan trọng là đặt thông tin về quyền hạn (isAdmin) trong đối tượng user
    isAdmin: true, // Hoặc false tùy thuộc vào việc bạn xác định quyền hạn của người dùng
      ...
      if (currentUser) {
        ...
        if (doc.exists) {
          ...
          if (isAdmin) {
            ...
            navigation.navigate('MainNav', { user: userData });
          } else {
