  ...
  const BookingScreen = ({navigation, route}) => {
    ...
    const handlePayment = () => {
      navigation.navigate('PaymentScreen', {
        selectedSeats,
        movie: movies[0] // Truyền thông tin về phim, ở đây lấy phim đầu tiên trong danh sách 'movies'
      });
    };
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.bookButton} onPress={() => navigation.navigate('PaymentScreen', {movieTitle: movieDetails.title })}>
        <PaymentScreen movieId={movieId} movieTitle={movieTitle} navigation={navigation} />
