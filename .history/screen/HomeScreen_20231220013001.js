...
const HomeScreen = ({ navigation }) => {
  ...
  <View key={index} style={styles.MovieContainer}>
    ...
    <View style={styles.bannerTextContainer}>
      ...
      {banner.description && <Text style={styles.bannerDescription}>{banner.description}</Text>}
    </View>
  </View>
);
    ...
    <ScrollView style={styles.ScrollViewcontainer}>
      <View style={styles.container}>
       ...
       <View>
        ...
        <Carousel 
        autoplay autoplayTimeout={3000} loop index={0} pageSize={width} sliderWidth={width} itemWidth={width}>
          {banners.length > 0 ? (
