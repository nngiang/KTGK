...
const BookingScreen = () => {
  ...
  const [vipSeats, setVIPSeats] = useState([1, 2, 3, 4, 5, 67, 8]); // Ghế VIP
  const [normalSeats, setNormalSeats] = useState([9, 10, 11, 1213,14,15,16]); // Ghế thường
  const [economySeats, setEconomySeats] = useState([17,18,19,20,21,22,23,24]); // Ghế hạng thấp
