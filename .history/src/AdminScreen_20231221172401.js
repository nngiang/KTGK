...
import { const MovieManagementScreen = () => {
  , ManageShowtimesScreen, ManageUsersScreen } from '../src'; 
  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator initialRouteName="ManageMovies">
        <Drawer.Screen name="ManageMovies" component={const MovieManagementScreen = () => {
